...
2.Steamのプロパティから、VRChatの起動オプションに[--enable-sdk-log-levels]を追加します。

1.VRChatが起動しているPCでLog_Monitor_v_X_X_X.exeを起動します。

2.セットアップ済みのアバターに着替えて、EXMenuからOSCが有効になっていることを確認します。

3.表示用オブジェクトは自動で表示されます。

4.VRChatがOSCを受信し、オブジェクト部分にデータが反映されます。
