...
〇2022/09/20 【Beta v2.1.2】
-テクスチャのAlpha Is Transparencyにチェックが入っていなかったミスを修正
-EditorディレクトリをLog_Monitorディレクトリ以下に移動しました
-[実験的]UI2.0のデザインに合わせたテクスチャをセットアップしたunitypackageを同梱
-[実験的]OSCの送受信IP、ポート番号を引数で指定できるようになりました
